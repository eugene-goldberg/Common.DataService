...
{
    public class DimDtlIncidentDayMap : EntityTypeConfiguration<DimDtlIncidentDay>
    {
        public DimDtlIncidentDayMap()
        {
            // Primary Key
            ...
            this.ToTable("DimDtlIncidentDay");
            ...
            this.Property(t => t.ReportedDay).HasColumnName("ReportedDay");
